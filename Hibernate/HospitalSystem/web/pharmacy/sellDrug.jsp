                                            ...
                                            <c:choose>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Drug <small>(required)</small></label> <select
                                                                    ...
                                                                    <%
                                                                        for (Drug drug : drugs) {
                                                                    %>
                                                                    <option value="<%=drug.getDrugId()%>" <%if (selledDrug.getDrug().getDrugId().equals(drug.getDrugId())) {
                                                                            out.print("selected");
                                                                        }%> >
                                                            ...
                                                            <div class="form-group">
                                                                <label>Patient <small>(required)</small></label> <select
                                                                    ...
                                                                    <option value="<%=patient.getPatientId()%>"
                                                                            <%if (selledDrug.getPatient().getPatientId() == patient.getPatientId()) {
                                                                                    out.print("selected");
                                                                                }%>>
                                                                        <%=patient.getName()%>
                                                ...
                                                <c:otherwise>
                                                    <form action="Process?action=SellDrug" method="POST">
                                                        ...
                                                        <div class="col-sm-3 ">
                                                            <div class="form-group">
                                                                <div id="sandbox-container">
                                                                    ...
                                                                    <div class="input-daterange input-group"
                                                                         id="datepicker">
                                                                        <input class="form-control" name="endTake" type="text" placeholder="00/00/0000" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <input type="submit" class="btn btn-round btn-fill btn-info"
                                                                       value="Selled Drug" />
                                                            </div>
                                                        </div>
                                                    </form>
