...
<html>
    <head>
        ...
        <script>
            function sendSuccess() {
                demo.showNotification('top', 'right', 'Message Sent Successfuly',
                        'success');
            }
            function error() {
    ...
    <body
        <c:if test="${not empty param['success']}">  onload="sendSuccess();" </c:if>
        <c:if test="${not empty param['error']}">  onload="error();" </c:if>
            ...
            <div class="main-panel">
                ...
                <%@include file="templates/user/compose.jsp"%>
