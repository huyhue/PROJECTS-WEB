            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="card">
                    <div class="card-header text-center" data-background-color="red">
                        <h4 class="title">Manage Nurse Service Time</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            <a href="servicetime.jsp?utime=<%=nurseServiceTime.getNurseServiceTimeID()%>" rel="tooltip" title="Edit Room" class="btn btn-primary btn-simple btn-xs">
                                                                <i class="material-icons">edit</i>
                                                            </a> 
                                                            <a href="Process?action=DeleteServiceTime&nurseServiceTimeID=<%=nurseServiceTime.getNurseServiceTimeID()%>"rel="tooltip" title="Remove" class="btn btn-danger btn-simple btn-xs"> 
