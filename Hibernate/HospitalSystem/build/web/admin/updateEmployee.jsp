    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="wizard-card" data-color="red" id="wizardProfile">
                <form method="POST" action="Process?action=UpdateEmployee" enctype="multipart/form-data">
                    <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                    <input type="hidden" name="employeeID"
                           value="<%=selectedEmployeeID%>" />
                    <div class="wizard-header">
                        <h3>
                            <b>Update</b> Employee info <br> <small>This information about Employee.</small>
                        </h3>
                    </div>
