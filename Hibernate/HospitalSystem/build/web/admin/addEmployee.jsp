...
<a href="#" class="made-with-mk">
    ...
    <div class="made-with">
        Made with <strong>Huyhue</strong>
    </div>
</a>
<div class="content">
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="wizard-card" data-color="red" id="wizardProfile">
                <form method="POST" action="Process?action=AddEmployee" enctype="multipart/form-data">
                    <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                    <div class="wizard-header">
                        <h3>
                            <b>Add</b> Employee info <br> <small>This information about employee.</small>
                        </h3>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input name="firstname" type="text" class="form-control" placeholder="Mosatafa...">
                                    </div>
                                </div>
                                <div class="col-sm-3 ">
                                    <div class="form-group">
                                        <label>Father Name <small>(required)</small></label> 
                                        <input required name="fathername" type="text" class="form-control" placeholder="Mostafa...">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="catgoryID" required>
                    ...
                    <div class="wizard-footer height-wizard">
                        <div class="pull-right">
                            <input type='button' class='btn btn-next btn-fill btn-warning btn-wd btn-sm'  name='next' value='Next' onclick="validatePassword();"/> 
                            <input type='submit' class='btn btn-finish btn-fill btn-warning btn-wd btn-sm' name='finish' value='Add Employee' />
                        </div>
                        <div class="pull-left">
        ...
        <div class="col-md-6">
            <div class="card col-sm-offset-1">
                ...
                <form action="" method="POST">
                    <table class="table table-striped table-bordered table-hover dt-responsive" id="allEmployees">
                            ...
                            <c:forEach items="${employees}" var="employee">
                                <tr>
                                    <td>
                                        ...
                                        <c:out value="${employee.fatherName}"/> 
                                        <c:out value="${employee.familyName}"/> 
                                    </td>
                                    <td><c:out value="${employee.category.categoryName}"/></td>
                                    <td><c:out value="${employee.type}"/></td>
                                    <td>
                                        <a href="empmgmt.jsp?uempid=${employee.employeeId}"><i class="material-icons">edit</i></a> 
                                        <a href="Process?action=deleteEmployee&dempid=${employee.employeeId}"><i class="material-icons">close</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
