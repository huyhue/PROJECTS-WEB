                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            <a href="mgmtroom.jsp?uroom=<%=room.getRoomId()%>" rel="tooltip" title="Edit Room" class="btn btn-primary btn-simple btn-xs"> 
                                                                <i class="material-icons">edit</i>
                                                            </a>
                                                            <a href="Process?action=DeleteRoom&roomID=<%=room.getRoomId()%>" rel="tooltip" title="Remove" class="btn btn-danger btn-simple btn-xs">
                                            ...
                                            <c:choose>
                                                <c:when test="${ not empty param['uroom'] }">
                                                    ...
                                                    <form action="Process?action=UpdateRoom" method="POST">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <input type="submit" class="btn btn-round btn-fill btn-info" value="Update Room" />
                                                            </div>
                                                        </div>
                                                    </form>
                                                </c:when>
                                                <c:otherwise>
                                                    <form action="Process?action=AddRoom" method="POST">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <input type="submit" class="btn btn-round btn-fill btn-info" value="Add Room"/>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </c:otherwise>
