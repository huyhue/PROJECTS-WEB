...
<html>
    <head>
        ...
        <script>
            function addBookBed() {
                demo.showNotification('top', 'right', 'Success Added Book Bed', 'success');
            }
            function updateBookBed() {
                demo.showNotification('top', 'right', 'Success Updated Book Bed', 'success');
            }
            function deleteBookBed() {
                demo.showNotification('top', 'right', 'Success Deleted Book Bed', 'success');
            }
            function error() {
    ...
    <body
        ...
        <c:if test="${not empty param['error']}">  onload="error();" </c:if>>
            ...
            <div class="main-panel">
                ...
                <%@include file="reception/bookbed.jsp"%>
