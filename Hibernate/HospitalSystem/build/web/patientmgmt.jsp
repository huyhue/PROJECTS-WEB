...
<html>
    <head>
        ...
        <script>
            function addPatient() {
                demo.showNotification('top', 'right', 'Success Added Patient','success');
            }
            function updatePatient() {
                demo.showNotification('top', 'right', 'Success Updated Patient','success');
            }
            function deletePatient() {
                demo.showNotification('top', 'right', 'Success Deleted Patient','success');
            }
            function error() {
