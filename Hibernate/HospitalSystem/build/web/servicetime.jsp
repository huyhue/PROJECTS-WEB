    ...
    <head>
        ...
        <script>
            function addServiceTime() {
                demo.showNotification('top', 'right', 'Success Added Service Time', 'success');
            }
            function updateServiceTime() {
                demo.showNotification('top', 'right', 'Success Updated Service Time', 'success');
            }
            function deleteServiceTime() {
                demo.showNotification('top', 'right', 'Success Deleted Service Time', 'success');
            }
            function error() {
