...
//        e.setDisabled("true".equalsIgnoreCase(disabled));
    ...
    private void listEmployee(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String description = request.getParameter("description");
        String disabled = request.getParameter("disabled");
        System.out.println("Dau salaryOperate:  " + salaryOperate);
        String where = "";
...
//        query = (TypedQuery<Employee>) HibernateUtil.getSessionFactory().openSession().createQuery(hql);
        Session session = HibernateUtil.getSessionFactory().openSession();
        Query query;
...
//		int count = result.intValue();
        ...
        System.out.println("Size list: " + employeeList.size());
